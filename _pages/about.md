...
permalink: /
title: "Inho Song"
excerpt: "PhD student in Computer Science at Virginia Tech — storage systems, SSDs, and HW-SW co-design."
author_profile: true
redirect_from:
  - /about/
  - /about.html
...
I am a Ph.D. student in Computer Science at **Virginia Tech**, co-advised by [Huaicheng Li](https://tinyurl.com/huaichenglicv) and [Sam H. Noh](https://people.cs.vt.edu/samhnoh/). My research centers on **software/hardware co-design for low, predictable end-to-end latency and high throughput** in modern storage systems — spanning SSD internals (FDP, ZNS), file systems, and the interfaces between them.
